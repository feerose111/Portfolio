    ...
    <section id="contact" className="py-20 px-4">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <div className="mb-16">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
            <a
              ...
              className="bg-gradient-to-r from-blue-600 to-indigo-600 text-white px-8 py-4 rounded-lg font-semibold text-lg hover:from-blue-700 hover:to-indigo-700 transition-all duration-300 shadow-lg hover:shadow-xl"
            >
              Contact me
            </a>
            <a
        ...
        <footer className="pt-8 border-t border-gray-200">
          <p className="text-gray-900 font-medium mb-1">Firoj Raut</p>
